...
// 	],
// 	"pageInfo" : {
// 		"currentPage" : Integer(Number),
// 		"totalPages" : Integer(Number),
// 		"numberOfElements" : Integer(Number),
// 		"pageSize" : Integer(Number),
// 		"totalElements" : Integer(Number)
// 	},
// 	"message" : String
// }


export const uploadedVideoData = [
  {
    id: 1,
    title: 'bts-1',
